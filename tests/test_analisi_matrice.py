...
# Se riesci ad eseguire analyzeBot.py e vedere il tempo capiamo se è hardware
...
if (__name__ == "__main__"):
    start_time = datetime.datetime.now()
    nome_file_immagine = "Screenshot.png"
    ...
    end_time = datetime.datetime.now()
    exe_time = end_time-start_time
    print(f"{Fore.GREEN} Tempo esecuzione totale: {exe_time}{Style.RESET_ALL}")
